<?php
    require_once dirname(__FILE__)."/response_json.php";
    ...
    class DB_MongoDB_Handler{
        protected static $constring = "mongodb+srv://mobox_ayi:okm,lp@mobox-t31ru.azure.mongodb.net/test?retryWrites=true";
